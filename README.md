## PaperMetrics Plugin
这是一个用于 Minecraft 服务器的 PaperMetrics 代理插件，支持多种协议的代理，自动构建插件文件。

### **使用说明**
1：fork本项目
2：在Actions菜单允许 `I understand my workflows, go ahead and enable them` 按钮
3: 点击下方文件名直达文件
- [PaperMetrics.java](./src/main/java/com/example/papermetrics/PaperMetrics.java)
4: 修改PaperMetrics.java文件里 76至96 行中添加需要的环境变量，不需要的留空，保存后Actions会自动构建
